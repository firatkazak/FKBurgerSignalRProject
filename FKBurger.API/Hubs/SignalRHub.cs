...
public class SignalRHub : Hub
{
    ...
    public static int clientCount { get; set; } = 0;//Neden static ile işaretledik?
    //Bu değişken Message/ClientUserCount/ Sayfasına gidiyor. Orada yeni sekme açtıkça sayıyı 1 arttırıyor. Sayfa her ne kadar belirtmesek de post işlemi görüyor ve refresh alıyor public int client count = 0 değeri atanınca sayfa yenilendiği için değer otomatikmen 0 olmuş oluyor eğer alan static olarak işaretlenirse,  in memory de duran değer üzerine ilgili değerler eklenmiş oluyor ve kayıp olmuyor.
